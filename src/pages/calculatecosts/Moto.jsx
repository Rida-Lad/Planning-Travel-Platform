      ...
      <div className="max-w-4xl mx-auto">
        <div className={cardClasses}>
          <h2 className={`text-3xl font-bold mb-8 text-center border-b pb-4 ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'
            ...
            Motorcycle <span className="text-yellow-500">Cost Calculator</span>
          </h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={inputClasses}
                  defaultValue={13.03} // default value for fuel price
                />
                <span className="text-sm text-gray-500">
                  You can enter a custom price if needed. The default is 13.03.
                </span>
              </div>
