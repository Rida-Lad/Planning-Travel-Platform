...
const TrainsOptions = () => {
  ...
  const fetchData = (city) => {
    axios.get(`http://localhost:5000/api/train-options`, {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
            Travel <span className="text-yellow-500">TrainsOptions</span>
          </h2>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className={`absolute top-4 right-4 w-10 h-10 rounded-lg flex items-center justify-center ${theme === 'dark' ? 'bg-yellow-500' : 'bg-yellow-400'
                  ...
                  <Train size={20} className="text-black" />
                </div>
